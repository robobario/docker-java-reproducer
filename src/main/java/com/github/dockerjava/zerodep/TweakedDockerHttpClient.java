...
public class TweakedDockerHttpClient implements DockerHttpClient {
    ...
    public TweakedDockerHttpClient(
            ...
            Duration responseTimeout, TimeValue validateAfterInactivity, Duration keepalive) {
        ...
        if (keepalive != null) {
            defaultRequest.setDefaultKeepAlive(keepalive.toNanos(), TimeUnit.NANOSECONDS);
        }
